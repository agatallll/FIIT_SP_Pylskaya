#include <allocator_boundary_tags.h> // заголовок реализованного аллокатора с граничными тегами
...
int main()
{
    try // глобальный перехват исключений
    {
        ...
        allocator_boundary_tags alloc(4096, nullptr, allocator_with_fit_mode::fit_mode::first_fit);
        ...
        char const* src = "boundary tags allocator demo";
